...
public class DriveStraightDistanceCommand extends Command {
    ...
    protected boolean isFinished() {
    	...
    	return DrivetrainSubsystem.getInstance().pidIsOnTarget() || time.get()>timeout || (Math.abs(DrivetrainSubsystem.getInstance().getPidOutput()) <= Constants.JOYSTICK_TOLERANCE && time.get()>0.5);
    }
