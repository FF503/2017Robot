...
public class RobotState extends Subsystem {
	...
	public enum ShootingPresets{
		NoTracking(30.0, 4500, 503), Batter(18.0,4000,271.0), HopperRed(40, 4150, 6.0), CenterPegBlue(40.0,4450,10), CenterPegRed(40.0, 5000, 223.0099056523927), PegNearHopperBlue(38.0, 4525, 272.0), PegNearHopperRed(37.5, 4525,301), HopperBlue(32.0,4350,198.0);
